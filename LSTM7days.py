...
def create_sequences(data, target, seq_length, step = 24):
    ...
    for i in range(0, len(data) - seq_length, step):
        ...
        y_seq = target[i + seq_length - (seq_length // 7):i + seq_length]
...
def objective(params):
    ...
    checkpoint = ModelCheckpoint('best_model_weights7.h5', monitor='val_loss', save_best_only=True, mode='min', verbose=1)
...
final_checkpoint = ModelCheckpoint('final_model_weights7.h5', monitor='val_loss', save_best_only=True, mode='min', verbose=1)
...
final_model.load_weights('final_model_weights7.h5')
